...
prefix_build="/c/mingw640/i686-640-win32-sjlj-rt_v5-rev0/mingw32/opt"
...
CFLAGS=$(echo "-O2 -pipe -fno-ident -I/c/mingw640/i686-640-win32-sjlj-rt_v5-rev0/mingw32/opt/include -I/c/mingw640/prerequisites/i686-zlib-static/include -I/c/mingw640/prerequisites/i686-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
